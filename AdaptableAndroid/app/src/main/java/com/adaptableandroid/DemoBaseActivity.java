...
/**
 * Created by Connie on 5/25/2015.
 */
...
public class DemoBaseActivity extends Activity implements OnItemClickListener {
...
//                "A Bar Chart plotting the sinus function with 8.000 values."));
        ...
        ListView lv = (ListView) findViewById(R.id.list_charts);
    ...
    private class MyAdapter extends ArrayAdapter<ContentItem> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(getContext()).inflate(R.layout.list_item_charts, null);
